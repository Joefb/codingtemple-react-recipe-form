...
export default function App() {
  ...
  return (
    <div className="relative grid min-h-[100vh] w-screen p-8">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          ...
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-2xl border border-gray-100">
            ...
            <div className="p-6 sm:p-8">
              ...
              {/* Optional: Add instructions / steps placeholder */}
              {/* You can expand this later when you add instructions to your data model */}
            </div>
      ...
      {/* {showRecipe && ( */}
      {/*   <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50"> */}
      {/*     <div className="bg-white p-8 rounded shadow-lg relative w-1/2 m-10 h-1/2"> */}
      {/*       <button */}
      {/*         className="absolute top-2 right-2 text-gray-500 hover:text-gray-700" */}
      {/*         onClick={() => setShowRecipe(false)} */}
      {/*       > */}
